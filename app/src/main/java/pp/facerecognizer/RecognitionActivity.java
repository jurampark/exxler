...
* objects.
*/
public class RecognitionActivity extends CameraActivity implements OnImageAvailableListener {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        AlertDialog editDialog = new AlertDialog.Builder(RecognitionActivity.this)
